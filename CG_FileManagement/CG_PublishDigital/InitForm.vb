Class InitForm
    ...
    Public Sub BahanUkuran(frm As PublishDigital)
        ...
        JsonHandler.FillCBfromJson(frm.cb_bahan, parsedJenis(frm.cb_jenisorder.SelectedValue).Root, "kode", "bahan")
    End Sub
    Public Sub FinishingA3(frm As PublishDigital)
        JsonHandler.FillTabwithCB(frm, Globals.JsonObj("cgFinishing")("a3colorfn"), 7, 7, 5)
    End Sub
    ...
    Public Sub LayoutList(frm As PublishDigital)
        ...
        JsonHandler.FillCBfromJson(frm.cb_layout, parsedJenis(frm.cb_jenisorder.SelectedValue).Root, "kode", "type")
    End Sub
